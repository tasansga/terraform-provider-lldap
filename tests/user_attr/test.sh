...
echo "=== User Attribute CRUD Lifecycle Test ==="
...
tofu taint lldap_user_attribute.test_attr
tofu apply -auto-approve
...
# Test different attribute types (valid for user attributes: DATE_TIME, INTEGER, JPEG_PHOTO, STRING)
...
echo "=== Test Editable Settings ==="
tofu apply -auto-approve -var test_is_editable=false
tofu apply -auto-approve -destroy -var test_is_editable=false

echo "=== All user attribute CRUD tests completed successfully! ==="
