...
echo "=== User Attribute Assignment CRUD Lifecycle Test ==="
...
# Test JPEG_PHOTO attribute (base64 encoded)
...
tofu apply -auto-approve
# Remove assignment only (keep user and attribute)
...
echo "=== All user attribute assignment CRUD tests completed successfully! ==="
